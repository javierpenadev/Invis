...
при выходе и после сбоев, детект занятого порта 53); Tor SOCKS 127.0.0.1:9050;
I2P-прокси 4444/4447, консоль 7070; tray со статусами; автозапуски; бэкап DNS.
Дальше по плану: kill switch, мосты Tor, экран логов, TUN-режим.
